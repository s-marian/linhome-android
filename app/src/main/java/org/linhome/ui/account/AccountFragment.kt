...
class AccountFragment : Fragment() {
    ...
    fun gotoFreeSip() {
        DialogUtil.confirm(
            ...
            { _: DialogInterface, _: Int ->
                val browserIntent =
                    Intent(Intent.ACTION_VIEW, Uri.parse(LinhomeApplication.corePreferences.config.getString("assistant","freesip_url","https://subscribe-staging.linhome.org/login")))
